...
main() {
    ...
    AMI_ID="ami-042b4708b1d05f512"  # Amazon Linux 2 in eu-north-1 (replace if needed)
    INSTANCE_TYPE="t3.micro"
    KEY_NAME="shell-scripting-devops-keypair"         # REPLACE WITH YOUR KEY PAIR NAME
    SUBNET_ID="subnet-05b82ffa1d6ed7599"       # REPLACE WITH YOUR SUBNET ID
    SECURITY_GROUP_IDS="sg-0da8edcdf0574aaac"            # Leave empty when using subnet-id
